...
The Risk & paper page’s **Read-only local paper-operation audit timeline** displays retained paper ledger events chronologically with lifecycle state, order/instrument context, retained fixture quantity/price fields, decision context and promotion evidence identifiers when present. It cannot submit, cancel, reconcile, amend, synchronize or route any order. See `docs/LOCAL_PAPER_AUDIT_TIMELINE.md` for field meanings and limits.
